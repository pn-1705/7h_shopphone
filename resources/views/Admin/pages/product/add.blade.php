...
{{--                            cấu hình--}}
                            <div class="form-group d-flex justify-content-between">
                                <div class="">
                                    ...
                                    <input name="HDH" type="text" class="form-control">
                                </div>
                                <div class="">
                                    <label for="inputStatus">Thông số cam sau</label>
                                    <input name="CamSau" type="text" class="form-control">
                                </div>
                                <div class="">
                                    <label for="inputStatus">Thông số cam trước</label>
                                    <input name="CamTruoc" type="text" class="form-control">
                                </div>
                                <div class="">
                            ...
                            <div class="form-group d-flex justify-content-between">
                                ...
                                <div class="">
                                    ...
                                    <input name="Rom" type="text" class="form-control">
                                </div>
                                <div class="">
                                    <label for="inputStatus">Thẻ SD</label>
                                    <input name="SDCard" type="text" class="form-control">
                                </div>
                                <div class="">
